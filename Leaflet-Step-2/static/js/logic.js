...
function createMap(earthquakes) {
  ...
  var myMap = L.map("map", {
    ...
    zoom: 5,
    layers: [satellitemap, earthquakes, newLayer]
  });
  ...
  // Fetch the data and create the new layer for the plates data
  d3.json(platesQueryUrl).then(function (data) {
    L.geoJSON(data, {
      style: function () {
        return { color: "orange" }
      }
...
legend.onAdd = function() {
    ...
    var colors =["#d7301f","#eaa92c","#F7DB11","#92ea2c","#2ceabf","#2c99ea"];
